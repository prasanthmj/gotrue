...
CREATE INDEX  IF NOT EXISTS users_instance_id_idx  ON {{ index .Options "Namespace" }}users (instance_id);
  
CREATE INDEX  IF NOT EXISTS users_instance_id_email_idx  ON {{ index .Options "Namespace" }}users (instance_id, email);
